...
class PromisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promise" do
    assert_difference('Promise.count') do
      post promises_url, params: { promise: { amount: @promise.amount, description: @promise.description, id: @promise.id, name: @promise.name } }
    end
  ...
  test "should update promise" do
    patch promise_url(@promise), params: { promise: { amount: @promise.amount, description: @promise.description, id: @promise.id, name: @promise.name } }
